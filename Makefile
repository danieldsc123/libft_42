...
#    Updated: 2024/10/29 19:58:25 by danielda         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
ft_striteri.c ft_strmapi.c *ft_calloc.c ft_bzero.c ft_memcpy.c ft_memmove.c ft_memchr.c ft_memcmp.c ft_strdup.c ft_atoi.c ft_itoa.c ft_putchar_fd.c ft_putstr_fd.c ft_putendl_fd.c ft_putnbr_fd.c
OBJ = $(SRC:.c=.o)
CC = cc 
